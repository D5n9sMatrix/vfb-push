...
(function(root, undefined) {
    ...
    Dictionary.prototype.get_item = function(key) {
        if (!this.contains(key)) throw new Error('Key ' + key + ' does not exist.');
        return this.get(key);
    };
    Dictionary.prototype.set_item = (function(add) { return function(key, value) { add.call(this, key, value); }; })(Dictionary.prototype.add);
    Dictionary.prototype.add = (function(old) {
        return function(key, value) {
            if (this.contains(key)) throw new Error('Key ' + key + ' already exists.');
            old.call(this, key, value);
        };
    })(Dictionary.prototype.add);
    Dictionary.prototype.remove = (function(old) {
        return function(key) {
            var r = this.contains(key);
            old.call(this, key);
            return r;
        };
